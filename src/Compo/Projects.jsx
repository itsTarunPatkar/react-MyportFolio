    ...
    return (
        <Container style={{ minHeight: '100vh', width: '100%' }}>
            ...
            <Row className='projects-1 justify-content-evenly'>
                <h3 className=' text-center ' style={{ borderBottom: '11px white ' }}>
                    E-Mistri
                </h3>
                <Col md={5} sm={12}>
                ...
                <Col md={7} sm={12} className=' d-flex flex-column justify-content-center' >
            ...
            <Row className='projects-1 justify-content-evenly'>
                <h3 className=' text-center pt-3' style={{ borderTop: '2px solid ', borderBottomWidth: '0%' }}>
                    Brand landing page
                </h3>
                <Col md={5} sm={12} className='d-flex flex-column '>
                    ...
                    <div className="visit-icons d-flex justify-content-evenly">
                        ...
                        <a href="https://brand-landingpage.vercel.app/" target="_blank" rel="noopener noreferrer">
                            <button type="button" class="btn btn-outline-info">
                                Live Demo  &#160;
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z" />
